...
export default function Chrome({ children }) {
  ...
  const from = `/auth?from=${encodeURIComponent(location.pathname || '/marketplace')}`;
      ...
      <header className="topbar">
        <div className="topbar-row">
          ...
          <nav className="nav icon-nav" aria-label="Marketplace">
            ...
            <a href="/forum" title="Forum" aria-label="Forum">
            ...
            <a href="/marketplace/signal" title="Signal" aria-label="Signal">
            ...
            <a className="trophy" href="/marketplace/competitive" title="Competitive" aria-label="Competitive">
            ...
            <a className="pkn-chip" href="/wallet" title="Wallet">0 PKN</a>
            <a href={signedIn ? '/profile' : from} title={signedIn ? 'Profile' : 'Sign in'} aria-label={signedIn ? 'Profile' : 'Sign in'}>
            ...
            <a className="cart-chip" href="/cart" title="Cart" aria-label="Cart, 0 items">
        ...
        <div className={`mobile-panel ${menu ? 'on' : ''}`}>
          ...
          <a href="/marketplace/signal" onClick={closeMenu}>Signal</a>
          <a href="/marketplace/competitive" onClick={closeMenu}>Competitive</a>
          <a href="/wallet" onClick={closeMenu}>Wallet</a>
      ...
      <footer className="foot">
        <div className="foot-grid">
          ...
          <div>
            ...
            <a href="/marketplace/signal">Signal</a>
            <a href="/docs">Docs</a>
          </div>
        </div>
      </footer>
